...
def _img_tag(filename: str, caption: str = "") -> str:
    """Return an HTML <img> tag with base64-encoded PNG content."""
...
def _md_img(filename: str) -> str:
    """Placeholder tag in Markdown that gets replaced during HTML build."""
...
- The dataset spans {data_shape[0]} Pokémon entries (including alternate forms) across 9 generations.
- Legendary and Mythical Pokémon ({legend_count} total) have significantly higher base stat totals.
...
def markdown_to_html(markdown_text: str) -> str:
    """Convert Markdown to HTML and replace IMG placeholders with base64 images."""
    ...
    def replace_placeholder(match):
        ...
        captions = {
            ...
            "type_counts.png":        "Figure: Pokémon Count by Primary Type",
            "stats_by_legendary.png": "Figure: Base Stat Total — Regular vs Legendary",
            "generation_counts.png":  "Figure: Pokémon Entries per Generation",
